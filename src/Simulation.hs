...
module Simulation (Simulation (..), SimulationState, Name, addSituation, apply, applyAll, changeSituation, getSimulationState, newSimulation)
    where
...
getSimulationState :: Name -> Simulation -> Either String SimulationState
